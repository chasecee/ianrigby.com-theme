			...
			<div class="container-fluid overflow-scroll">
				<div class="row">
					...
					<?php foreach ($images as $image) : ?>
						...
						<div class="col">
							<a href="<?php echo $image['url']; ?>" data-fancybox="top-images" data-caption="<?php if ($image['alt']) : echo $image['alt'];
																											else : echo $image['title'];
																											endif; ?>">
				...
				<div class="padder">
					<div class="container" style="border-top: 2px solid #99885b;">
						<div class="symbol_wrap text-center">
							<img alt="page decoration" src="/wp-content/themes/base-theme-child/img/symbol-mid.svg" width="120">
						</div>
					</div>
				</div>
				<div class="container">
					...
					<div class="row grid">
						...
						<?php foreach ($bottom_images as $bottom_image) : ?>
							...
							<div class="col-sm-4 grid-item">
								<a href="<?php echo $bottom_image['url']; ?>" data-fancybox="gallery" data-caption="<?php if ($bottom_image['alt']) : echo $bottom_image['alt'];
																													else : echo $bottom_image['title'];
																													endif; ?>">
